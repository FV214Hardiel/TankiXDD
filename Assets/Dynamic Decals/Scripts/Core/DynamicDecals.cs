...
namespace LlockhamIndustries.Decals
{
    ...
    */
    ...
    public class DynamicDecals : MonoBehaviour
    {
        ...
        public static DynamicDecals System
        {
            get
            {
                if (system == null)
                {
                    ...
                    {
                        hideFlags = HideFlags.DontSaveInEditor | HideFlags.DontSaveInBuild | HideFlags.HideInHierarchy | HideFlags.HideInInspector
                    };
        ...
        #region Cameras
        //Scene camera data
        internal Dictionary<Camera, CameraData> cameraData = new();
        ...
        public Camera CustomCamera
        {
            get
            {
                ...
                {
                    GameObject cameraObject = new("Custom Camera");
...
#pragma warning disable CS0618
        ...
        #if UNITY_EDITOR
        private List<GameObject> dragables = new();
